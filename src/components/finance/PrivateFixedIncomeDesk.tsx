...
import type { PrivateProductType, PrivateRateType } from "@/lib/private-fixed-income";
import { cn } from "@/lib/utils";
import { toast } from "sonner";
import { usePrivateFixedIncomeDesk } from "./use-private-fixed-income-desk";
...
export function PrivateFixedIncomeDesk({ showArchived = false }: { showArchived?: boolean }) {
  const {
    ...
    save,
  } = usePrivateFixedIncomeDesk(showArchived);
